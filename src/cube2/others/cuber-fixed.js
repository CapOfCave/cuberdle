...
ERNO.Projector = (function(){
	...
	return function( cube, domElement ){
		...
		// now save to use in strict mode
		function getBoundingClientRect( element ){
			...
			console.log("element.getBoundingClientRect", bounds, {
				left: bounds.left + window.pageXOffset - d.clientLeft,
				top: bounds.top + window.pageYOffset - d.clientTop,
				x: bounds.x, 
				y: bounds.y,
				width: bounds.width,
			...
			return { // no spread operator possible, sadly
				left: bounds.left + window.pageXOffset - d.clientLeft,
				top: bounds.top + window.pageYOffset - d.clientTop,
				x: bounds.x, 
				y: bounds.y,
